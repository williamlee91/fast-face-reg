...
IMAGE_SIZE = 96
TRAIN_HDF5 = "/home/yww/hdf5dataset/data_hdf5_96_0.99_2/train.hdf5"
VAL_HDF5 = "/home/yww/hdf5dataset/data_hdf5_96_0.99_2/val.hdf5"
weight_decay = 1e-7
...
class Model_train:
    ...
    def train(self, data_path):        
        ...
        plt.savefig('model8_add_128/acc8_big.png')
        plt.close()

        plt.plot(epochs, loss, 'r-')
        plt.plot(epochs, val_loss, 'b-')
        plt.title('Training and validation loss')
        plt.savefig('model8_add_128/loss8_big.png')
...
class EveryEpochCheckpoint(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):  #log must be defined
        self.model_to_save.save('model8_add_128/model_%d.h5' % epoch)    
...
class HignestAccCheckpoint(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None): #log must be defined
        ...
        if acc >= self.highest: # save best model
            self.highest = acc
            self.model_to_save.save('model8_add_128/best_model.h5')
...
if __name__ == '__main__':
    ...
    print(input_shape)
    path = '/home/yww/data'
    path_data = '/home/yww/hdf5dataset/data_hdf5_96_0.99_2'
    ...
    if not os.path.exists('model8_add_128'):
        os.makedirs('model8_add_128')
    ...
    print('Model Saved.')
    model.save_model(file_path = 'model8_add_128/model_last.h5')

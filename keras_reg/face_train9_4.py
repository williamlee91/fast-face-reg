...
class Model_train:
    ...
    def train(self, data_path):  
        ...
        plt.savefig('model9_4/acc9_bigdata.png')
        plt.close()
        
        plt.plot(epochs, loss, 'r-')
        plt.plot(epochs, val_loss, 'b-')
        plt.title('Training and validation loss')
        plt.savefig('model9_4/loss9_bigdata.png') 
...
class EveryEpochCheckpoint(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):  #log must be defined
        self.model_to_save.save('model9_4/model_%d.h5' % epoch)    
...
class HignestAccCheckpoint(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None): #log must be defined
        ...
        if acc >= self.highest: # save best model
            self.highest = acc
            self.model_to_save.save(os.path.join(path,'best_model.h5'))
...
if __name__ == '__main__':
    ...
    print('Model Saved.')
    model.save_model(file_path = os.path.join(path, 'best_weights.h5'))

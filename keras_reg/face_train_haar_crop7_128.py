...
from load_face_dataset7 import load_dataset, resize_image, IMAGE_SIZE
...
class Model_train:
    ...
    def Squeezenet(self, nb_classes, dataset):
        ...
        avgpool11 = AveragePooling2D((4,4), name='avgpool11')(merge10_11)
...
#        relu11 = Activation('relu', name='relu11')(bn11)
        ...
        self.model = Model(inputs = input_img, outputs = dense)
        
        #plot_model(self.model, to_file='home/yww/model/squeezenetface6.png', show_shapes=True)
    ...
    def train(self, dataset, batch_size = 32, epochs = 40, data_augmentation = True):        
        ...
        optimizer = Adam(lr=0.001, beta_1= 0.9, beta_2= 0.999, epsilon= 0.01)
        ...
        plt.savefig('model/acc7_50.png')
        plt.close()

        plt.plot(epochs, loss, 'r-')
        plt.plot(epochs, val_loss, 'b-')
        plt.title('Training and validation loss')
        plt.savefig('model/loss7_50.png')
    ...
    def load_model(self, file_path):
        self.model = load_model(file_path,custom_objects={'loss': cl.loss,
                                                          'accuracy':cl.categorical_accuracy})
...
if __name__ == '__main__':
    ...
    # 读取数据
    dataset = Dataset('face_asia_500_aug200') 
    # 读取路径    
    path_name = 'face_asia_500_aug200'
    dataset.load()
    model = Model_train()
    ...
    print('Model Saved.')
    model.save_model(file_path = 'model/squeezenetface7_50.h5')

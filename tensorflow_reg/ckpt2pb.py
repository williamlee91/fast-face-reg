# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 10:34:04 2019
...
MODEL_DIR = "E:/LightFaceNet-master/LightFaceNet-master/output/ckpt_best"
MODEL_NAME = "simplefacenet_new9_4.pb"
...
def freeze_graph(model_folder):
    ...
    output_node_names = "embeddings" #原模型输出操作节点的名字
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_folder",default="E:/LightFaceNet-master/LightFaceNet-master/output/ckpt_best/simplefacenet_new9_4", type=str, help="input ckpt model dir") #命令行解析，help是提示符，type是输入的类型，

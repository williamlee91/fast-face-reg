...
# /usr/bin/env/python3
"""
Created on Sat Jul 13 11:39:12 2019
...
class AMSGrad_v2(optimizer.Optimizer):
    ...
    def _apply_dense(self, grad, var):
        ...
        step = lr * m_t / (v_sqrt + epsilon_t)
        var_update = self.layca(var,step,lr)
